<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"D:\web\phpweb\sean\public/../app/index\view\User_order\refund_detail.html";i:1577786062;s:50:"D:\web\phpweb\sean\app\index\view\common\link.html";i:1576206405;s:57:"D:\web\phpweb\sean\app\index\view\common\mobile-part.html";i:1574418883;s:58:"D:\web\phpweb\sean\app\index\view\common\head-message.html";i:1574574104;s:57:"D:\web\phpweb\sean\app\index\view\common\header-part.html";i:1574596376;s:52:"D:\web\phpweb\sean\app\index\view\common\footer.html";i:1576824908;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
	...
	<div id="main">
				...
				<div class="row">
					<div class="col-sm-12">
						<ul class="breadcrumbs">
							...
							<li><a href="<?php echo url('User_order/index'); ?>">订单列表</a></li>
							<li>退换货详情</li>
						</ul>
					</div>
				</div>
		...
		<div class="section pt-7 pb-7">
			<div class="container">
				<div class="row">
                    <!-- 侧栏导航 -->
					<div class="col-md-12" style="padding: 20px; background-color: #F2F2F2;min-height:400px;">
  								...
  								<tbody>
  	                            	<tr class="cart_item" style="border:0;">
  										<td class="product-thumbnail">
  											<a href="<?php echo url('Shopdateil/index',array('id'=>$order_goods['goods_id'])); ?>">
  												<img src="<?php echo $order_goods['goods_thumb']; ?>" alt="<?php echo $order_goods['goods_name']; ?>">
  											</a>
  										</td>
										<td class="product-thumbnail">
											<a href="<?php echo url('Shopdateil/index',array('id'=>$order_goods['goods_id'])); ?>"><?php echo $order_goods['goods_name']; ?></a>
										</td>
  										<td class="product-quantity">
  											<span class="sub-title">退款编号：<?php echo $order_return['return_sn']; ?></span>
  										</td>
  										<td class="product-subtotal">
  											<span class="sub-title">申请时间：<?php echo date("Y-m-d H:i:s",$order_return['return_time']); ?></span>
  										</td>
										<td class="product-subtotal" style="min-width:210px;">
                                            <?php switch($order_return['return_status']): case "-1": ?><span class="sub-title">取消退款</span><?php break; case "0": ?><span class="sub-title">等待处理结果</span><?php break; case "1": ?><span class="sub-title">申请退款成功</span><?php break; case "2": ?><span class="sub-title">申请不通过</span><?php break; default: endswitch; ?>
										</td>
  									</tr>
									<tr>
										<td class="product-subtotal">
											<span class="sub-title" style="display:block;">退款金额：￥<?php echo $order_return['return_money']; ?></span>
										</td>
										<td class="product-subtotal">
											<button type="button" class="layui-btn layui-btn-sm layui-btn-warm">
												<a href="javascript:;" style="color:white;">取消申请退货退款</a>
											</button>
										</td>
	  								</tr>
  								</tbody>
