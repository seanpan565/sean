<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:66:"D:\web\phpweb\sean\public/../app/index\view\user\user_message.html";i:1574911489;s:50:"D:\web\phpweb\sean\app\index\view\common\link.html";i:1576206405;s:57:"D:\web\phpweb\sean\app\index\view\common\mobile-part.html";i:1574418883;s:58:"D:\web\phpweb\sean\app\index\view\common\head-message.html";i:1574574104;s:57:"D:\web\phpweb\sean\app\index\view\common\header-part.html";i:1577867210;s:58:"D:\web\phpweb\sean\app\index\view\common\user-sidebar.html";i:1576577744;s:52:"D:\web\phpweb\sean\app\index\view\common\footer.html";i:1577863894;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
        ...
        <span class="layui-nav-bar" style="top: 272.5px; height: 0px; opacity: 0;"></span>
					...
					<div class="col-md-9">
                        <div class="layui-form-item">
						    ...
						    <div class="layui-form-mid layui-word-aux" style="float:right;"><button type="button" class="layui-btn layui-btn-primary layui-btn-sm">修改密码</button></div>
						</div>

						<div class="layui-form-item">
						    <label class="layui-form-label" style="width:120px;">支付密码</label>
							<?php if($user['user_payword'] == ''): ?>
							<div class="layui-form-mid layui-word-aux">启用支付密码功能，为您资产账户安全加把锁</div>
						    <div class="layui-form-mid layui-word-aux" style="float:right;"><button type="button" class="layui-btn layui-btn-primary layui-btn-sm">设置密码</button></div>
                            <?php else: ?>
							<div class="layui-form-mid layui-word-aux">您已设置支付密码</div>
							<div class="layui-form-mid layui-word-aux" style="float:right;"><button type="button" class="layui-btn layui-btn-primary layui-btn-sm">立即更换</button></div>
							<?php endif; ?>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-form-mid layui-word-aux">您验证的手机，若已丢失或停用，请立即更换</div>
							<div class="layui-form-mid layui-word-aux" style="float:right;"><button type="button" class="layui-btn layui-btn-primary layui-btn-sm">立即更换</button></div>
							<?php else: ?>
							<div class="layui-form-mid layui-word-aux">绑定手机号码，为您资产账户安全加把锁</div>
							<div class="layui-form-mid layui-word-aux" style="float:right;"><button type="button" class="layui-btn layui-btn-primary layui-btn-sm">绑定手机</button></div>
							<?php endif; ?>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-form-mid layui-word-aux">您验证的邮箱，若已丢失或停用，请立即更换</div>
							<div class="layui-form-mid layui-word-aux" style="float:right;"><button type="button" class="layui-btn layui-btn-primary layui-btn-sm">立即更换</button></div>
							<?php else: ?>
							<div class="layui-form-mid layui-word-aux">绑定邮箱，为您资产账户安全加把锁</div>
							<div class="layui-form-mid layui-word-aux" style="float:right;"><button type="button" class="layui-btn layui-btn-primary layui-btn-sm">绑定邮箱</button></div>
							<?php endif; ?>
						</div>
