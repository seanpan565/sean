<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:65:"D:\web\phpweb\sean\public/../app/index\view\order\cart_order.html";i:1575887013;s:50:"D:\web\phpweb\sean\app\index\view\common\link.html";i:1574593823;s:57:"D:\web\phpweb\sean\app\index\view\common\mobile-part.html";i:1574418883;s:58:"D:\web\phpweb\sean\app\index\view\common\head-message.html";i:1574574104;s:57:"D:\web\phpweb\sean\app\index\view\common\header-part.html";i:1574596376;s:52:"D:\web\phpweb\sean\app\index\view\common\footer.html";i:1574596358;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
				...
				<div class="row">
					<div class="col-md-8">
						<table class="table shop-cart">
							<tbody>
                            <?php if(is_array($cart['0']) || $cart['0'] instanceof \think\Collection || $cart['0'] instanceof \think\Paginator): $i = 0; $__LIST__ = $cart['0'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								<tr class="cart_item">
									...
									<td class="product-info">
										<a href="shop-detail.html"><?php echo $vo['goods_name']; ?></a>
										<span class="sub-title"><?php echo $vo['goods_keyword']; ?></span>
										<span class="sub-title" style="text-decoration: line-through;">￥<?php echo $vo['goods_price']; ?></span>
									</td>
									<td class="product-quantity">
										<span class="sub-title">x<?php echo $vo['goods_count']; ?></span>
									</td>
									<td class="product-subtotal">
										<span class="sub-title">￥<?php echo $vo['goods_vip']; ?></span>
									</td>
                                    <td class="product-subtotal">
                            ...
                            <?php endforeach; endif; else: echo "" ;endif; ?>
								<tr>
									<td colspan="5" class="actions">
										<a class="continue-shopping" href="#"> 返回购物车</a>
                                        <span class="update-cart" style="border:0;">小计:￥<?php echo $cart['1']; ?></span>
									</td>
								</tr>
							</tbody>
						</table>
