<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:72:"D:\web\phpweb\sean\public/../app/index\view\User_order\comment_list.html";i:1577083472;s:50:"D:\web\phpweb\sean\app\index\view\common\link.html";i:1576206405;s:57:"D:\web\phpweb\sean\app\index\view\common\mobile-part.html";i:1574418883;s:58:"D:\web\phpweb\sean\app\index\view\common\head-message.html";i:1574574104;s:57:"D:\web\phpweb\sean\app\index\view\common\header-part.html";i:1574596376;s:58:"D:\web\phpweb\sean\app\index\view\common\user-sidebar.html";i:1576577744;s:52:"D:\web\phpweb\sean\app\index\view\common\footer.html";i:1576824908;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
  								...
  								<tbody>
									<?php if(is_array($order_goods) || $order_goods instanceof \think\Collection || $order_goods instanceof \think\Paginator): $i = 0; $__LIST__ = $order_goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
  	                            	<tr class="cart_item" style="border:0;">
										...
										<td class="product-subtotal">
											<?php if($vo['is_comment'] == 0): ?>
												<button type="button" class="layui-btn layui-btn-sm layui-btn-normal" data-toggle="modal" data-target="#myModal" data-target=".modleDailog" onclick="values('<?php echo $vo['order_sn']; ?>', '<?php echo $vo['goods_id']; ?>', '<?php echo $vo['order_goods_id']; ?>')">立即评价
													<!-- <a href="<?php echo url('Order/orderPay',array('order_sn'=>$vo['order_sn'])); ?>" style="color:white;">立即评价</a> -->
												</button>
											<?php else: ?>
										    	<span class="sub-title">已评价</span>
											<?php endif; ?>
...
layui.use(['layer', 'form'], function() {
	...
	function(data) {
		...
		$.ajax({
			...
			dataType:"json",
			data:{data:dataadd},
			url:"<?php echo url('UserOrder/comment_order'); ?>",
			success:function(data){
				if (data.status == 1) {
