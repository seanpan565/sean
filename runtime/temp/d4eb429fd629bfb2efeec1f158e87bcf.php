						...
						<div class="tplay-body-div">
						    <form class="layui-form" id="admin">
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										...
										<?php endif; ?>
										<!-- 路径 -->
										<input type="hidden" name="thumb" id="input-thumb" value="<?php echo $usermsg['thumb']; ?>">
									</div>
								</div>
						        <div class="layui-form-item">
							        <label class="layui-form-label">用户名</label>
							        <div class="layui-input-inline" style="min-width:500px;">
										<?php if($usermsg['user_name'] == ''): ?>
							            <input name="user_name" lay-verify="required" autocomplete="off" class="layui-input" type="text" placeholder="请输入您的用户名，不可更改">
										<?php else: ?>
										<input readonly="readonly" autocomplete="off" class="layui-input" type="text" placeholder="<?php echo $usermsg['user_name']; ?>">
										<?php endif; ?>
							        </div>
						        </div>
								<div class="layui-form-item">
									  ...
									  <div class="layui-input-block">
										<input type="radio" name="user_sex" value="1" title="男" <?php if($usermsg['user_sex'] == 1): ?> checked="checked" <?php endif; ?>><div class="layui-unselect layui-form-radio layui-form-radioed"><i class="layui-anim layui-icon layui-anim-scaleSpring"></i><div>是</div></div>
										<input type="radio" name="user_sex" value="0" title="女" <?php if($usermsg['user_sex'] == 0): ?> checked="checked" <?php endif; ?>><div class="layui-unselect layui-form-radio"><i class="layui-anim layui-icon"></i><div>否</div></div>
									  </div>
								</div>
						        <div class="layui-form-item">
							...
							layui.use('upload', function(){
								...
								var uploadInst = upload.render({
									elem:'#btn-thumb',
									url: "<?php echo url('index/common/upload'); ?>",
									size:2500,
									exts: 'jpg|png|jpeg',
									before: function(obj){
