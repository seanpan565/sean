	...
	<div id="main">
		<div class="section section-bg-10 pt-11 pb-17">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h2 class="page-title text-center">article item</h2>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-md-9 col-md-push-3">
						<div style="text-align: center;height:150px;">
							...
							<p style="margin:10px;"><?php echo date("Y-m-d",$articleItem['create_time']); ?></p>
							<p style="margin:10px;"><?php echo $articleItem['read_count']; ?></p>
						</div>
						...
						<div class="sidebar">
							<div class="widget widget-product-categories">
								...
								<ul class="product-categories">
									<?php if(is_array($articleCate) || $articleCate instanceof \think\Collection || $articleCate instanceof \think\Paginator): $i = 0; $__LIST__ = $articleCate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
									<li><a href="<?php echo url('article/articleCate',array('id'=>$vo1['id'])); ?>"><?php echo $vo1['name']; ?></a></li>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</ul>
							</div>
							<div class="widget widget-products">
								...
								<ul class="product-list-widget">
                                    <?php if(is_array($article_istop) || $article_istop instanceof \think\Collection || $article_istop instanceof \think\Paginator): $i = 0; $__LIST__ = $article_istop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?>
									<li>
										<a href="<?php echo url('article/article',array('id'=>$vo2['id'])); ?>">
											<img src="<?php echo geturl($vo2['thumb']); ?>" alt="<?php echo $vo2['title']; ?>" />
											<span class="product-title"><?php echo $vo2['title']; ?></span>
										</a>
										<ins>阅读数：<?php echo $vo2['read_count']; ?></ins>
									</li>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
								</ul>
							</div>
