<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"D:\web\phpweb\sean\public/../app/index\view\User_order\order_details.html";i:1576654513;s:50:"D:\web\phpweb\sean\app\index\view\common\link.html";i:1576206405;s:57:"D:\web\phpweb\sean\app\index\view\common\mobile-part.html";i:1574418883;s:58:"D:\web\phpweb\sean\app\index\view\common\head-message.html";i:1574574104;s:57:"D:\web\phpweb\sean\app\index\view\common\header-part.html";i:1574596376;s:52:"D:\web\phpweb\sean\app\index\view\common\footer.html";i:1576824908;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
				...
				<div class="row">
						<div class="col-md-8">
                            <div class="layui-card-header">
                                <sapn>订单编号：<?php echo $orderdata['order_sn']; ?></sapn>
                                <sapn style="margin-left:20px;">下单时间：<?php echo date("Y-m-d H:i:s",$orderdata['create_time']); ?></sapn>
                            </div>
	                            ...
	                            <?php endforeach; endif; else: echo "" ;endif; ?>
									<tr>
										<td colspan="6" class="actions">
											<a class="continue-shopping" href="<?php echo url('UserOrder/index'); ?>">返回订单列表</a>
	                                        <span class="update-cart" style="border:0;">总价:￥<?php echo $orderdata['pay_amount']; ?></span>
										</td>
									</tr>
								</tbody>
							</table>
	                            ...
	                            <table>
	                                <tbody>
                                        <tr class="cart-subtotal">
                                            <th>订单状态</th>
                                            <td class="product-subtotal">
                                                <span class="sub-title" <?php if($orderdata['order_status'] == 0): ?>style="display:block;" <?php else: ?> style="display:none;"<?php endif; ?>>未付款</span>
                                                <span class="sub-title" <?php if($orderdata['order_status'] == 1): ?>style="display:block;" <?php else: ?> style="display:none;"<?php endif; ?>>已付款</span>
                                                <span class="sub-title" <?php if($orderdata['order_status'] == 2): ?>style="display:block;" <?php else: ?> style="display:none;"<?php endif; ?>>已发货</span>
                                                <span class="sub-title" <?php if($orderdata['order_status'] == 3): ?>style="display:block;" <?php else: ?> style="display:none;"<?php endif; ?>>待评价</span>
                                                <span class="sub-title" <?php if($orderdata['order_status'] == 4): ?>style="display:block;" <?php else: ?> style="display:none;"<?php endif; ?>>已评价</span>
                                                <span class="sub-title" <?php if($orderdata['order_status'] == 5): ?>style="display:block;" <?php else: ?> style="display:none;"<?php endif; ?>>已取消</span>
                                                <span class="sub-title" <?php if($orderdata['order_status'] == 6): ?>style="display:block;" <?php else: ?> style="display:none;"<?php endif; ?>>交易关闭</span>
                                                <span class="sub-title" <?php if($orderdata['order_status'] == 7): ?>style="display:block;" <?php else: ?> style="display:none;"<?php endif; ?>>退款中的订单</span>
                                                <span class="sub-title" <?php if($orderdata['order_status'] == 8): ?>style="display:block;" <?php else: ?> style="display:none;"<?php endif; ?>>付款超时</span>
                                            </td>
                                        </tr>
	                                    <tr class="cart-subtotal">
	                                        <th>运费</th>
	                                    ...
	                                    <tr class="shipping">
	                                        <th>姓名</th>
	                                        <td><?php echo $orderdata['address_name']; ?></td>
	                                    </tr>
	                                    <tr class="order-total">
	                                        <th>电话</th>
	                                        <td><?php echo $orderdata['address_phone']; ?></td>
	                                    </tr>
	                                    <tr class="cart-subtotal">
	                                        <th>地址</th>
	                                        <td style="height:150px;width:200px;padding:1px 1px;"><?php echo $orderdata['address_site']; ?></td>
	                                    </tr>
	                                </tbody>
	                            </table>
	                        </div>
