<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:71:"D:\web\phpweb\sean\public/../app/index\view\user_message\up_mobile.html";i:1578033711;s:50:"D:\web\phpweb\sean\app\index\view\common\link.html";i:1576206405;s:57:"D:\web\phpweb\sean\app\index\view\common\mobile-part.html";i:1574418883;s:58:"D:\web\phpweb\sean\app\index\view\common\head-message.html";i:1574574104;s:57:"D:\web\phpweb\sean\app\index\view\common\header-part.html";i:1577867210;s:58:"D:\web\phpweb\sean\app\index\view\common\user-sidebar.html";i:1577869481;s:52:"D:\web\phpweb\sean\app\index\view\common\footer.html";i:1577863894;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
                        ...
                        <div class="w3_info">
                            ...
                            <form action="javascript:;" method="post">
								<div class="layui-form-item">
									...
									<div class="layui-form-mid layui-word-aux">您验证的手机<?php echo $user_mobile['user_mobile']; ?></div>
								</div>
								...
								<div class="input-group" style="padding-right:0px;">
									...
									<img class="form-control" onclick="cachephone()" style="width:40%;height:40px;float:right;padding: 0;" src="<?php echo captcha_src(); ?>" alt="图形验证码">
								</div>
								<div class="input-group" style="padding-right:0px;">
...
<script>
	...
	//点击验证码切换
	function cachephone() {
		var src = "<?php echo url('UserMessage/verify'); ?>";
	...
	function sendMobileCode (obj) {
		...
		//发送时手机号码
		$.ajax({
			url: "<?php echo url('UserMessage/sendCode'); ?>",
			async: false,
			type: "POST",
	...
	*/
	 ...
	 */
 	function ajax_reg (data) {
 		$.ajax({
 			url:"<?php echo url('UserMessage/upMobile'); ?>",
 			async: false,
 			type: "POST",
 			data: data,
 			dataType: "json",
