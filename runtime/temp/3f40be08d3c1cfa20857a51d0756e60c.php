<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:66:"D:\web\phpweb\sean\public/../app/index\view\register\register.html";i:1575530701;s:50:"D:\web\phpweb\sean\app\index\view\common\link.html";i:1576206405;s:57:"D:\web\phpweb\sean\app\index\view\common\mobile-part.html";i:1574418883;s:58:"D:\web\phpweb\sean\app\index\view\common\head-message.html";i:1574574104;s:57:"D:\web\phpweb\sean\app\index\view\common\header-part.html";i:1577867210;s:52:"D:\web\phpweb\sean\app\index\view\common\footer.html";i:1577863894;}*/ ?>
﻿<!doctype html>
<html lang="zh-CN">
<head>
							...
							<div class="agile_info">
								...
								<div class="w3_info">
									...
									<form action="javascript:;" method="post">
										...
										<div class="input-group" style="padding-right:0px;">
											...
											<input type="text" placeholder="验证码" required="" style="width:50%;" id="mobile_code">
											<input type="button" value="获取验证码" class="dyMobileButton" onclick="sendMobileCode(this);" style="width:40%;height:40px;float:right;padding: 0;">
										</div>
										<div class="input-group">
								...
								<div class="w3_info">
									...
									<form action="javascript:;" method="post">
										...
										<div class="input-group" style="padding-right:0px;">
											<span><i class="fa fa-envelope" aria-hidden="true"></i></span>
											<input type="text" placeholder="验证码" required="" style="width:50%;">
											<input type="button" value="获取验证码" id="email_code" class="dyEmailButton" onclick="sendEmailCode(this);" style="width:40%;height:40px;float:right;padding: 0;">
										</div>
										<div class="input-group">
											<span><i class="fa fa-lock" aria-hidden="true"></i></span>
