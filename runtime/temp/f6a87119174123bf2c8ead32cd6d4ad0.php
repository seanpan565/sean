<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:66:"D:\web\phpweb\sean\public/../app/index\view\user\edit_address.html";i:1574845074;s:50:"D:\web\phpweb\sean\app\index\view\common\link.html";i:1574593823;s:57:"D:\web\phpweb\sean\app\index\view\common\mobile-part.html";i:1574418883;s:58:"D:\web\phpweb\sean\app\index\view\common\head-message.html";i:1574574104;s:57:"D:\web\phpweb\sean\app\index\view\common\header-part.html";i:1574596376;s:52:"D:\web\phpweb\sean\app\index\view\common\footer.html";i:1574596358;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0">
<title>水果鲜生-修改收货地址</title>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<ul class="layui-nav layui-nav-tree layui-inline" lay-filter="demo" style="margin-right: 10px;width: 100%;">
							<li class="layui-nav-item"><a href="javascript:;" title="个人信息">个人信息</a></li>
							<li class="layui-nav-item"><a href="javascript:;" title="安全设置">安全设置</a></li>
							<li class="layui-nav-item"><a href="javascript:;" title="收货地址">收货地址</a></li>
							...
							<li class="layui-nav-item"><a href="javascript:;" title="我的收藏">我的收藏</a></li>
                        ...
                        <div class="tplay-body-div">
                            <div class="layui-tab">
                              <ul class="layui-tab-title">
                                  <li><a href="<?php echo url('user/addresslist'); ?>" class="a_menu">收货地址列表</a></li>
                                ...
                                <form class="layui-form" id="admin">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-inline" style="min-width:500px;">
                                            <input name="address_name" lay-verify="required" autocomplete="off" class="layui-input" type="text" placeholder="请输入收货人" value="<?php echo $edit_default['address_name']; ?>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label" style="width:100px;">手机号码</label>
                                        <div class="layui-input-inline" style="min-width:500px;">
                                            <input name="address_phone" lay-verify="required" autocomplete="off" class="layui-input" type="text" placeholder="请输入手机号码" value="<?php echo $edit_default['address_phone']; ?>">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label" style="width:100px;">详细地址</label>
                                        <div class="layui-input-inline" style="min-width:500px;">
                                            <textarea placeholder="详细地址" class="layui-textarea" name="address_site"><?php echo $edit_default['address_site']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                          <label class="layui-form-label" style="width:100px;">设为默认</label>
                                          <div class="layui-input-inline">
                                            <input type="radio" name="is_default" value="1" title="是" <?php if($edit_default['is_default'] == 1): ?> checked="checked" <?php endif; ?> ><div class="layui-unselect layui-form-radio layui-form-radioed"><i class="layui-anim layui-icon layui-anim-scaleSpring"></i><div>是</div></div>
                                            <input type="radio" name="is_default" value="0" title="否" <?php if($edit_default['is_default'] == 0): ?> checked="checked" <?php endif; ?> ><div class="layui-unselect layui-form-radio"><i class="layui-anim layui-icon"></i><div>否</div></div>
                                          </div>
                                    </div>
                                    <input type="hidden" name="id" value="<?php echo $edit_default['id']; ?>">
                                    <div class="layui-form-item">
                    ...
                    success:function(res) {
                        if(res.code == 1) {
                            layer.alert(res.msg, function(index){
                              location.href = "<?php echo url('user/addresslist'); ?>";
                            })
                        } else {
                            layer.msg(res.msg);
                        }
