<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\web\phpweb\sean\public/../app/admin\view\goodscate\publish.html";i:1572954360;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="tplay-body-div">
    <div class="layui-tab">
      <ul class="layui-tab-title">
        <li><a href="<?php echo url('admin/goodscate/index'); ?>" class="a_menu">商品分类管理</a></li>
      ...
      layui.use(['layer', 'form'], function() {
          ...
          $(window).on('load', function() {
              form.on('submit(admin)', function(data) {
                  $.ajax({
                      url:"<?php echo url('admin/goodscate/publish'); ?>",
